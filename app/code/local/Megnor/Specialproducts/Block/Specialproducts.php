<?php class Megnor_Specialproducts_Block_Specialproducts extends Mage_Core_Block_Template { 
	...
	public function _prepareLayout()
    {
		...
		if(Mage::getStoreConfig('specialproducts/general/active') && Mage::getStoreConfig('specialproducts/listing_home/slider')){
			$this->getLayout()->getBlock('head')->addItem('skin_css', 'css/specialproducts/skin_special.css');
		}
		if(Mage::getStoreConfig('specialproducts/general/active') && Mage::getStoreConfig('specialproducts/sidebar/specialslider')){
			$this->getLayout()->getBlock('head')->addItem('skin_css', 'css/specialproducts/skin_vartical.css');
			$this->getLayout()->getBlock('head')->addItem('skin_js', 'js/specialproducts/jcarousel_vertical.js');
		}
    }
	...
	public function getPriceDisplay(){		
		return Mage::getStoreConfig('specialproducts/sidebar/price');		
    }
	
	public function getAddtocart(){		
		return  Mage::getStoreConfig('specialproducts/sidebar/add_to_cart');		
    }
	
	public function enablespecialslider(){		
		return  Mage::getStoreConfig('specialproducts/sidebar/specialslider');		
    }
}  