<?php class Megnor_Specialproducts_Block_Specialproductslist extends Mage_Catalog_Block_Product_Abstract
{
	...
	public function getPriceDisplay() {		
		return Mage::getStoreConfig('specialproducts/listing_home/price');		
    }
	
	public function getAddtocart() {		
		return  Mage::getStoreConfig('specialproducts/listing_home/add_to_cart');		
    }
	
	public function isActiveSlider() {		
		return  Mage::getStoreConfig('specialproducts/listing_home/slider');		
    }
