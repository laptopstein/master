...
if( Mage::getStoreConfig('newproducts/general/active') && Mage::getStoreConfig('newproducts/sidebar/enablednewsidebarslider')){			
$this->getLayout()->getBlock('head')->addItem('skin_css', 'css/newproducts/skin_vartical.css');			
$this->getLayout()->getBlock('head')->addItem('skin_js', 'js/newproducts/jcarousel_vertical.js');		
}    }    
...
public function getNewProductCollection()    {    	       
	...
	return Mage::getStoreConfig('newproducts/sidebar/price');		    
	}		
	
	public function getAddtocart() {				
	return  Mage::getStoreConfig('newproducts/sidebar/add_to_cart');		    
	}	
	
	public function getnewsidebarslider() {				
	return  Mage::getStoreConfig('newproducts/sidebar/enablednewsidebarslider');		    
