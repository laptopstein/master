...
class Megnor_Bestseller_Block_Bestsellerlist extends Mage_Catalog_Block_Product_Abstract
{
	...
	public function isActiveSlider() {		
		return  Mage::getStoreConfig('bestseller/listing_home/slider');		
    }
	
	public function getPriceDisplay() {		
		return  Mage::getStoreConfig('bestseller/listing_home/price');		
    }
	
	public function getAddtocart() {		
		return  Mage::getStoreConfig('bestseller/listing_home/add_to_cart');		
    }
} 
