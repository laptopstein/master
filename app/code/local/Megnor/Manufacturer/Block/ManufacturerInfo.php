...
class Megnor_Manufacturer_Block_ManufacturerInfo extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $breadcrumbs->addCrumb('manufacturers', array('label'=>Mage::helper('manufacturer')->__('All Brands'), 'title'=>Mage::helper('manufacturer')->__('Go to All Brands List'), 'link'=>Mage::helper('manufacturer')->getManufacturersUrl()));
		...
		if(Mage::getStoreConfig('manufacturer/general/enable') && Mage::getStoreConfig('manufacturer/cmspage/slider')){
			...
			$this->getLayout()->getBlock('head')->addItem('skin_js', 'js/manufacturer/jquery.jcarousel.min.js');
			$this->getLayout()->getBlock('head')->addItem('skin_js', 'js/manufacturer/jcarousel.js');
		}
