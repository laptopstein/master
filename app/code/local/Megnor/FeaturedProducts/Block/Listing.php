...
class Megnor_FeaturedProducts_Block_Listing extends Mage_Catalog_Block_Product_Abstract {
	...
	protected function isActiveSlider() {
        return Mage::getStoreConfig("featuredproducts/cmspage/slider");
    }
	
	protected function getPriceDisplay() {
        return Mage::getStoreConfig("featuredproducts/cmspage/price");
    }
	
	protected function getAddtocart() {
        return Mage::getStoreConfig("featuredproducts/cmspage/add_to_cart");
    }
